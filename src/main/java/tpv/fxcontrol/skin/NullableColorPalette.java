...
class NullableColorPalette extends Region {
    ...
    public NullableColorPalette(final NullableColorPicker colorPicker) {
...
//                colorPicker.show();
    ...
    class ColorSquare extends StackPane {
        ...
        public ColorSquare(Color color, int index, ColorType type) {
            ...
            String tooltipStr = NullableColorPickerSkin.tooltipString(color);
