...
import tpv.fxcontrol.skin.FlowViewSkin;
...
public class FlowView<T> extends Control {
    ...
    public static <T> EventType<FlowView.EditEvent<T>> editAnyEvent() {
        return (EventType<FlowView.EditEvent<T>>) EDIT_ANY_EVENT;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> EventType<FlowView.EditEvent<T>> editStartEvent() {
        return (EventType<FlowView.EditEvent<T>>) EDIT_START_EVENT;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> EventType<FlowView.EditEvent<T>> editCancelEvent() {
        return (EventType<FlowView.EditEvent<T>>) EDIT_CANCEL_EVENT;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> EventType<FlowView.EditEvent<T>> editCommitEvent() {
        return (EventType<FlowView.EditEvent<T>>) EDIT_COMMIT_EVENT;
    }
     ...
     */
    public FlowView(ObservableList<T> items) {
        ...
        // Install default....
        // ...selection model
        setSelectionModel(new FlowView.ListViewBitSetSelectionModel<T>(this));

        // ...focus model
        setFocusModel(new FlowView.ListViewFocusModel<T>(this));
    ...
    private EventHandler<FlowView.EditEvent<T>> DEFAULT_EDIT_COMMIT_HANDLER = t -> {
    ...
    // --- Cell Factory
    private ObjectProperty<Callback<FlowView<T>, FlowCell<T>>> cellFactory;
     ...
     */
    public final void setCellFactory(Callback<FlowView<T>, FlowCell<T>> value) {
     ...
     */
    public final Callback<FlowView<T>, FlowCell<T>> getCellFactory() {
    ...
    public final DoubleProperty fixedCellSizeProperty() {
        if (fixedCellSize == null) {
            fixedCellSize = new StyleableDoubleProperty(Region.USE_COMPUTED_SIZE) {
                @Override public CssMetaData<FlowView<?>,Number> getCssMetaData() {
    ...
    // --- On Edit Start
    private ObjectProperty<EventHandler<FlowView.EditEvent<T>>> onEditStart;
     ...
     * an edit
     */
    public final void setOnEditStart(EventHandler<FlowView.EditEvent<T>> value) {
     ...
     */
    public final EventHandler<FlowView.EditEvent<T>> getOnEditStart() {
    ...
    // --- On Edit Commit
    private ObjectProperty<EventHandler<FlowView.EditEvent<T>>> onEditCommit;
     ...
     */
    public final void setOnEditCommit(EventHandler<FlowView.EditEvent<T>> value) {
     ...
     */
    public final EventHandler<FlowView.EditEvent<T>> getOnEditCommit() {
    ...
    // --- On Edit Cancel
    private ObjectProperty<EventHandler<FlowView.EditEvent<T>>> onEditCancel;
     ...
     * an edit
     */
    public final void setOnEditCancel(EventHandler<FlowView.EditEvent<T>> value) {
     ...
     */
    public final EventHandler<FlowView.EditEvent<T>> getOnEditCancel() {
    ...
    @Override protected Skin<?> createDefaultSkin() {
        return new FlowViewSkin<T>(this);
    }
    ...
    private static class StyleableProperties {
        private static final CssMetaData<FlowView<?>,Orientation> ORIENTATION =
                new CssMetaData<FlowView<?>,Orientation>("-fx-orientation",
                        new EnumConverter<Orientation>(Orientation.class),
                        Orientation.VERTICAL) {

                    @Override
                    public Orientation getInitialValue(FlowView<?> node) {
                        // A vertical ListView should remain vertical
                        return node.getOrientation();
                    }

                    @Override
                    public boolean isSettable(FlowView<?> n) {
                        return n.orientation == null || !n.orientation.isBound();
                    }

                    @SuppressWarnings("unchecked") // orientationProperty() is a StyleableProperty<Orientation>
                    @Override
                    public StyleableProperty<Orientation> getStyleableProperty(FlowView<?> n) {
                        return (StyleableProperty<Orientation>)n.orientationProperty();
                    }
                };

        private static final CssMetaData<FlowView<?>,Number> FIXED_CELL_SIZE =
                new CssMetaData<FlowView<?>,Number>("-fx-fixed-cell-size",
                        SizeConverter.getInstance(),
                        Region.USE_COMPUTED_SIZE) {

                    @Override public Double getInitialValue(FlowView<?> node) {
                        return node.getFixedCellSize();
                    }

                    @Override public boolean isSettable(FlowView<?> n) {
    ...
    public static class EditEvent<T> extends Event {
        ...
        private final FlowView<T> source;
         ...
         */
        public EditEvent(FlowView<T> source,
                         EventType<? extends FlowView.EditEvent<T>> eventType,
                         T newValue,
                         int editIndex) {
         ...
         */
        @Override public FlowView<T> getSource() {
            return source;
        }
    ...
    static class ListViewBitSetSelectionModel<T> extends MultipleSelectionModelBase<T> {
        ...
        public ListViewBitSetSelectionModel(final FlowView<T> listView) {
            if (listView == null) {
        ...
        private final FlowView<T> listView;
...
//            }
    ...
    static class ListViewFocusModel<T> extends FocusModel<T> {
        ...
        public ListViewFocusModel(final FlowView<T> listView) {
            if (listView == null) {
                throw new IllegalArgumentException("ListView can not be null");
            }
